/**
 * 自定义table，访问后台数据queryList接口数据返回json格式不一致，做出解析不同
 * table.js 解析分页查询json
 */
/**
...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  //字符常量
  ,MOD_NAME = 'all_list_table', ELEM = '.layui-table', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled', NONE = 'layui-none'
