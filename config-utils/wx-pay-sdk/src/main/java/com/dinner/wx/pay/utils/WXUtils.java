...
public class WXUtils {
    ...
    public JSONObject getJsapiAccessTokenByCode(String code) {
        ...
        try {
            ...
            log.info("appid -> "+WXPayConstants.APP_ID+",secret -> "+WXPayConstants.SECRET);
    ...
    public JSONObject refushAccessToken(String refresh_token){
        // 通过接口取得access_token
        String access_token_json= restTemplate.getForObject(MessageFormat.format(WXURL.FLUSH_ACCESS_TOKEN_URL, WXPayConstants.APP_ID,refresh_token), String.class);
    ...
    public JSONObject getJsapiUserinfo(String access_token, String openid) {
        ...
        try {
            ...
            String userinfo_json = HttpClient.sendPost(MessageFormat.format(WXURL.OAUTH_GET_USERINFO_URL, access_token,WXPayConstants.APP_ID),null);
