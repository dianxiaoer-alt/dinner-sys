...
public class WXPayRequest {
    ...
    public WXPayRequest(WXPayRequestConfig config,final WXPayConfig wxPayConfig) throws Exception {
    ...
    private String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        if (useCert) {
            // 证书
            char[] password = config.getMCH_ID().toCharArray();
        ...
        httpPost.addHeader("User-Agent", WXPayConstants.USER_AGENT + " " + config.getMCH_ID());
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        WXPayDomain.DomainInfo domainInfo = wxPayConfig.getWXPayDomain().getDomain(wxPayConfig);
        if (domainInfo == null) {
        ...
        try {
            ...
            wxPayConfig.getWXPayDomain().report(domainInfo.domain, elapsedTimeMillis, null);
            WXPayReport.getInstance(config,wxPayConfig).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
        ...
        wxPayConfig.getWXPayDomain().report(domainInfo.domain, elapsedTimeMillis, exception);
        throw exception;
    }
    ...
    public String requestWithoutCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, wxPayConfig.getHttpConnectTimeoutMs(), wxPayConfig.getHttpReadTimeoutMs(), false, autoReport);
    }
    ...
    public String requestWithCert(String urlSuffix, String uuid, String data, boolean autoReport) throws Exception {
        return this.request(urlSuffix, uuid, data, wxPayConfig.getHttpConnectTimeoutMs(), wxPayConfig.getHttpReadTimeoutMs(), true, autoReport);
    }
