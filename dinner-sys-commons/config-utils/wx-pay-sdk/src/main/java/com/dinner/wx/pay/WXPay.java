...
import com.dinner.wx.pay.utils.DateTimeUtil;
import com.dinner.wx.pay.utils.WXPayUtil;
...
public class WXPay {
    ...
    public WXPay(final WXPayRequestConfig config,final WXPayConfig wxPayConfig) throws Exception {
        this(config, wxPayConfig,null, true, false);
        // this(config, null, true, true);
    }

    public WXPay(final WXPayRequestConfig config, final WXPayConfig wxPayConfig,final boolean autoReport) throws Exception {
        this(config,wxPayConfig, null, autoReport, false);
        // this(config, null, autoReport, true);
    }


    public WXPay(final WXPayRequestConfig config,final WXPayConfig wxPayConfig, final boolean autoReport, final boolean useSandbox) throws Exception {
        this(config, wxPayConfig,null, autoReport, useSandbox);
    }

    public WXPay(final WXPayRequestConfig config,final WXPayConfig wxPayConfig, final String notifyUrl) throws Exception {
        this(config,wxPayConfig, notifyUrl, true, false);
    }

    public WXPay(final WXPayRequestConfig config, final WXPayConfig wxPayConfig,final String notifyUrl, final boolean autoReport) throws Exception {
        this(config,wxPayConfig, notifyUrl, autoReport, false);
    }

    public WXPay(final WXPayRequestConfig config,final WXPayConfig wxPayConfig, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        this.config = config;
        ...
        this.wxPayRequest = new WXPayRequest(config,wxPayConfig);
    }
    ...
    private void checkWXPayConfig() throws Exception {
        ...
        if (this.config.getAPP_ID() == null || this.config.getAPP_ID().trim().length() == 0) {
            throw new Exception("appid in config is empty");
        }
        if (this.config.getMCH_ID() == null || this.config.getMCH_ID().trim().length() == 0) {
            throw new Exception("appid in config is empty");
        }
        if (this.config.getAPICLIENT_CERT() == null) {
            throw new Exception("cert stream in config is empty");
        }
        if (this.wxPayConfig.getWXPayDomain() == null) {
            throw new Exception("config.getWXPayDomain() is null");
        }

        if (this.wxPayConfig.getHttpConnectTimeoutMs() < 10) {
            throw new Exception("http connect timeout is too small");
        }
        if (this.wxPayConfig.getHttpReadTimeoutMs() < 10) {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("appid", config.getAPP_ID());
        reqData.put("mch_id", config.getMCH_ID());
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getAPI_KEY(), this.signType));
        return reqData;
    }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getAPI_KEY(), this.signType);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getAPI_KEY(), signType);
    }
    ...
    public Map<String, String> microPay(Map<String, String> reqData) throws Exception {
        return this.microPay(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> microPayWithPos(Map<String, String> reqData) throws Exception {
        return this.microPayWithPos(reqData, this.wxPayConfig.getHttpConnectTimeoutMs());
    }
    ...
    public Map<String, String> sendRedPack(Map<String, String> reqData) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.redPackRequestData(reqData), wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    ...
    public Map<String, String> redPackRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("wxappid", config.getAPP_ID());
        reqData.put("mch_id", config.getMCH_ID());
    ...
    public Map<String, String> getRedPackInfo(Map<String, String> reqData) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData), wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml);
    }
    ...
    public Map<String, String> sendCoupon(Map<String, String> reqData) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.fillRequestDataNotType(reqData), wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    ...
    public Map<String, String> transfers(Map<String, String> reqData) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.transfersRequestData(reqData), wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
        return this.sendRedPackProcessResponseXml(respXml);
    }

    public Map<String, String> transfersRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("mch_appid", config.getAPP_ID());
        reqData.put("mchid", config.getMCH_ID());
        reqData.put("nonce_str", WXPayUtil.generateUUID());
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getAPI_KEY(), this.signType));
        return reqData;
    }
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData) throws Exception {
        return this.unifiedOrder(reqData, wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> orderQuery(Map<String, String> reqData) throws Exception {
        return this.orderQuery(reqData, wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> reverse(Map<String, String> reqData) throws Exception {
        return this.reverse(reqData, wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> closeOrder(Map<String, String> reqData) throws Exception {
        return this.closeOrder(reqData, wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> refund(Map<String, String> reqData) throws Exception {
        return this.refund(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> refundQuery(Map<String, String> reqData) throws Exception {
        return this.refundQuery(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> downloadBill(Map<String, String> reqData) throws Exception {
        return this.downloadBill(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> report(Map<String, String> reqData) throws Exception {
        return this.report(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> shortUrl(Map<String, String> reqData) throws Exception {
        return this.shortUrl(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> authCodeToOpenid(Map<String, String> reqData) throws Exception {
        return this.authCodeToOpenid(reqData, this.wxPayConfig.getHttpConnectTimeoutMs(), this.wxPayConfig.getHttpReadTimeoutMs());
    }
    ...
    public Map<String, String> chooseWXPayMap(String prepay_id, String nonce_str) throws Exception {
        ...
        chooseWXPayMap.put("appId", config.getAPP_ID());
        ...
        // 生成支付签名
        String paySign = WXPayUtil.generateSignature(chooseWXPayMap, config.getAPI_KEY());
