...
public class WXSignatureUtil {
	...
	private static  WXPayRequestConfig wxPayRequestConfig;

	public static Map<String,Object> getSignature(HttpServletRequest request, String requestUrl, WXPayRequestConfig config) throws ClientProtocolException, IOException, CloneNotSupportedException{
		wxPayRequestConfig = config;
		...
		String appid = wxPayRequestConfig.getAPP_ID();
		String secret = wxPayRequestConfig.getSECRET();
		String token;
		String jsapi_ticket;
