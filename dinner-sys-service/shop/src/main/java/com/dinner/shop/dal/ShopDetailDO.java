...
public interface ShopDetailDO {
     ...
     * @return 统计数量
     */
    int countPage(ShopDetail shopDetail);
     ...
     * @return 数据集合
     */
    List<ShopDetail> queryPage(ShopDetail query);
    ...
    ShopDetail queryOneByShopId(@Param("shop_id") Long shop_id);
}
