...
public interface ShopDetailAO {
	 ...
	 * @return shopDetailId
	 */
	Result<Long> insertShopDetail(ShopDetailReq shopDetailReq);
	/**
	 * <pre>
	 * 根据ID删除 记录
	 * // TODO 生成的代码，如果确认你已经使用该方法，请删除该行注释，不然后续清理代码的时候，将会删除该方法
	 * </pre>
	 *
	 * @param shopDetailId Id
	 * @return 改变数量
	 */
	Result<Integer> deleteById(Long shopDetailId);
	/**
	 * <pre>
	 * 根据ID查询 
	 * // TODO 生成的代码，如果确认你已经使用该方法，请删除该行注释，不然后续清理代码的时候，将会删除该方法
	 ...
	 * @return ShopDetail
	 */
	Result<ShopDetail> queryById(Long shopDetailId);
	 ...
	 * @return 修改记录数量
	 */
	Result<Integer> updateShopDetail(ShopDetailReq shopDetailReq);
	 ...
	 * @return      数据集合
	 */
	Result<List<ShopDetail>> queryList(ShopDetailQuery query);
