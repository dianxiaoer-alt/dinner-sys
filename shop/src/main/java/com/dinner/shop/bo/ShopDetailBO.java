...
public interface ShopDetailBO {
     ...
     * @throws 
     */
    int deleteById(Long shopDetailId);
    /**
     * <pre>
     * 分页查询
     * //TODO 生成的代码，如果确认你已经使用该方法，请删除该行注释，不然后续清理代码的时候，将会删除该方法
     ...
     *
     * @param page  分页信息
     * @param shopDetail 查询条件
     * @return 数据集合
     * @throws 
     */
    List<ShopDetail> queryPage(ShopDetail shopDetail);
    /**
     * <pre>
     * 根据ID查询
     * //TODO 生成的代码，如果确认你已经使用该方法，请删除该行注释，不然后续清理代码的时候，将会删除该方法
     ...
     * @throws 
     */
    ShopDetail queryById(Long shopDetailId);
    /**
     * <pre>
     * 根据ID修改
     * //TODO 生成的代码，如果确认你已经使用该方法，请删除该行注释，不然后续清理代码的时候，将会删除该方法
    ...
    int updateShopDetail(ShopDetail shopDetail);
     /**
     *
     * @param shopDetail  查询对象信息
     * @return 数据集合
     */
     List<ShopDetail> queryList(ShopDetail shopDetail);
}
